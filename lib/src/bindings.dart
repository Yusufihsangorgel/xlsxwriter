...
external int xlsxwConditionalCell(
  Pointer<Void> worksheet,
  int r1,
  int c1,
  int r2,
...
external int xlsxwConditionalCellBetween(
  Pointer<Void> worksheet,
  int r1,
  int c1,
  int r2,
...
@Native<
  Int32 Function(Pointer<Void>, Uint32, Uint32, Uint32, Uint32, Uint32, Uint32)
>(symbol: 'xlsxw_conditional_2color')
external int xlsxwConditional2Color(
  Pointer<Void> worksheet,
  int r1,
  int c1,
  int r2,
...
external int xlsxwConditional3Color(
  Pointer<Void> worksheet,
  int r1,
  int c1,
  int r2,
